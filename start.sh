...
export AIGATEWAY_CONSOLE_PORTALDB_DRIVER="${AIGATEWAY_CONSOLE_PORTALDB_DRIVER:-mysql}"
export PORTAL_MYSQL_HOST="${PORTAL_MYSQL_HOST:-127.0.0.1}"
export PORTAL_MYSQL_PORT="${PORTAL_MYSQL_PORT:-3306}"
export PORTAL_MYSQL_USER="${PORTAL_MYSQL_USER:-portal}"
export PORTAL_MYSQL_PASSWORD="${PORTAL_MYSQL_PASSWORD:-portal}"
export PORTAL_MYSQL_DATABASE="${PORTAL_MYSQL_DATABASE:-aigateway_portal}"
export PORTAL_MYSQL_PARAMS="${PORTAL_MYSQL_PARAMS:-parseTime=true&charset=utf8mb4&loc=Local}"
